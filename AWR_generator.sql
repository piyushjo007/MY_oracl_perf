...
--AWR-Generator.sql: generates AWS between snaps 
-- version v1.1
-- developed by piyushjoshi@apple.com
-- date : 05/01/2019
--------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------
...
-- Calling  Oracle common first input script to get start and end snap ids
