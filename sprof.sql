...
REM
REM $Header: 215187.1 coe_xfr_sql_profile.sql 11.4.1.5 2010/08/04 csierra $
REM
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('REM $Header: 215187.1 coe_xfr_sql_profile_&&sql_id._&&plan_hash_value..sql 11.4.1.5 '||TO_CHAR(SYSDATE, 'YYYY/MM/DD')||' csierra $');
  DBMS_OUTPUT.PUT_LINE('REM');
